...
action :add do
  ...
  sql_string += 'MASTER_PORT=' + new_resource.master_port + ', ' if new_resource.master_port != nil
  ...
  if new_resource.master_use_gtid == 'no'
    ...
    if new_resource.master_log_file != nil
      sql_string += ', MASTER_LOG_FILE=\'' + new_resource.master_log_file + '\''
